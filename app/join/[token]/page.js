  ...
  if (notFound) return (
    <div style={styles.center}>
      <div style={{textAlign:'center',padding:'0 32px'}}>
        ...
        <h2 style={{fontFamily:'Georgia,serif',fontSize:24,color:'#2C1A0E',marginBottom:10}}>Link not found</h2>
        <p style={{fontSize:14,color:'#8C6B4E',lineHeight:1.7}}>This invite link may have expired or already been used.<br/>Ask for a new link.</p>
      </div>
    </div>
  );
      ...
      <div style={{...styles.card, animation:'j-up .7s cubic-bezier(.22,.68,0,1.2) both'}}>
        ...
        <div style={{animation:'j-up .5s .18s both',textAlign:'center',marginBottom:28}}>
          ...
          <p style={{fontSize:13.5,color:'rgba(250,247,242,.38)',lineHeight:1.75,maxWidth:320,margin:'0 auto'}}>
            Add your memories and help build a story together. Your contributions are a surprise until the story is told.
          </p>
        </div>
        ...
        <div style={{animation:'j-up .5s .25s both',background:'rgba(196,114,74,.1)',border:'1px solid rgba(196,114,74,.2)',borderRadius:12,padding:'12px 16px',marginBottom:24,textAlign:'center'}}>
          <span style={{fontSize:13,color:'rgba(196,114,74,.9)',lineHeight:1.6}}>
            🤫 Your memories are private until the story is generated — it's a surprise for everyone.
          </span>
        </div>
        ...
        <div style={{animation:'j-up .5s .32s both'}}>
          ...
          <input
            ...
            placeholder="e.g. Nana, Uncle Erik, Sara…"
            autoFocus
            style={{
