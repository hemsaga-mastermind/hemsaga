    ...
    <>
      <style>{`
        ...
        nav.scrolled {
          ...
          padding: 16px 60px;
          border-bottom: 1px solid rgba(201,184,168,0.25);
        }
        .nav-logo {
        ...
        .story-preview-wrapper {
          margin-top: 80px; width:100%; max-width:680px; position:relative;
        }
        .story-card {
        ...
        .float-pill {
          position:absolute; border-radius:50px; font-size:11px; font-weight:500;
          letter-spacing:0.5px; padding:8px 16px; white-space:nowrap;
        ...
        .bubble-papa { background:var(--blush); top:0;left:0; width:240px; }
        .bubble-mama { background:var(--sage); top:80px;right:0; width:220px; }
        .bubble-dadi { background:var(--lavender); bottom:40px;left:40px; width:200px; }
        ...
        .cta-title { font-family:'Cormorant Garamond',serif; font-size:clamp(36px,4vw,56px); font-weight:300; color:#FAF7F2; margin-bottom:16px; }
        .cta-title em { font-style:italic; color:#E8D5D0; }
        .cta-subtitle { font-size:15px; color:rgba(250,247,242,0.6); margin-bottom:44px; line-height:1.8; }
      ...
      <section className="hero">
        ...
        <div className="hero-tag fade-up-1">Every family has a story worth telling</div>
        <h1 className="hero-title fade-up-2">
          Your family's <em>memories</em><br />woven into a living storybook
        </h1>
        <p className="hero-subtitle fade-up-3">
          Papa logs a moment. Mama adds a feeling.<br />
          Hemsaga weaves it all into a beautiful story<br />
        ...
        {/* Story Preview */}
        <div className="story-preview-wrapper fade-up-5" id="story">
          <div className="float-pill pill-1">📸 Memory logged</div>
          <div className="float-pill pill-2">✦ Chapter generated</div>
          <div className="float-pill pill-3">💌 Shared with Dadi</div>
          <div className="story-card">
            <div className="story-card-meta">
              <div className="story-chapter-tag">The Day Ivaan Stood</div>
              <div className="story-page-label">Chapter 4 · Page 1</div>
            </div>
            <h2 className="story-title">October, 2024 — Nine Months Old</h2>
            <p className="story-text">
              It happened on a Tuesday, the way most important things do —
              quietly, without announcement. Ivaan had been eyeing the sofa for weeks.{' '}
              <strong>Papa had joked that he was planning something.</strong>
              <br /><br />
              He was. On a crisp October morning, Ivaan reached out, grabbed the
              cushion with both fists, and <strong>pulled himself up</strong>.
              He wobbled. He steadied. He stood.
              <br /><br />
              Two hundred kilometres away, Dadi watched the video four times.
      ...
      <section className="section" id="how">
        ...
        <h2 className="section-title reveal">Three simple steps to a <em>lifetime</em> of stories</h2>
        <div className="steps-grid">
          {[
            ...
            { icon:'✦',  bg:'icon-sage',  num:'Step 02', title:'AI Weaves the Story', desc:'Hemsaga gathers all family contributions and crafts a beautifully written chapter in your family\'s own voice.' },
      ...
      <div className="family-section" id="family">
        <div className="family-inner">
          <div className="family-visual reveal">
            <div className="family-bubble bubble-papa">
              <div className="bubble-role">Papa · Norrköping</div>
              <div className="bubble-text">"He stood up today holding the sofa and just grinned at me."</div>
            </div>
            <div className="family-bubble bubble-mama">
              <div className="bubble-role">Mama · Home</div>
              <div className="bubble-text">"He's been planning this for weeks. I could see it in his eyes."</div>
            </div>
            <div className="family-bubble bubble-dadi">
              <div className="bubble-role">Dadi · Jaipur</div>
              <div className="bubble-text">"Mera beta khada ho gaya. I watched it four times."</div>
            </div>
          </div>
          <div className="family-content reveal">
            <p className="section-label">The family</p>
            <h2 className="section-title">Every voice adds a <em>different colour</em> to the story</h2>
            <p className="family-desc">
              Ivaan's story isn't just Ivaan's. It's Papa rushing home from work.
      ...
      <div className="quote-section reveal">
        ...
        <p className="quote-text">
          Ivaan will be eighteen one day and ask —
