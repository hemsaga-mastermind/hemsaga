...
const en = {
  ...
  more: 'More',
  moreMenuTitle: 'More',
  moreMenuDesc: 'Invite, avatar, feedback, and sign out.',
  feedback: 'Feedback',
  feedbackTitle: 'Suggestions & feedback',
  feedbackDesc: 'Bugs are prioritized. We review weekly and use this to improve the product.',
  feedbackTypeBug: 'Bug',
  feedbackTypeSuggestion: 'Suggestion',
  feedbackTypeOther: 'Other',
  feedbackPlaceholder: 'Describe the issue or idea…',
  feedbackContactPlaceholder: 'Your email (optional, for follow-up)',
  sendFeedback: 'Send feedback',
  feedbackSent: 'Thanks! We’ll review it.',
  ...
  addALittleMore: 'Add a little more (optional)',
  memQuestion1: 'What made that moment special?',
  memQuestion2: 'Any detail that would make the story more vivid?',
  ...
  switchSpaceDesc: 'Choose which story space to view.',
  editDate: 'Edit date',
  editDateDesc: 'Change when this memory happened.',
  saveDate: 'Save date',
  ...
  storyFamilyMemoriesHint: 'Your family has added memories — generate a chapter to read the story everyone is building.',
  dismiss: 'Dismiss',
