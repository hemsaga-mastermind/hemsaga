...
const sv = {
  ...
  spaceNamePlaceholderChild: 't.ex. Vår lillas berättelse',
  spaceNamePlaceholderCouple: 't.ex. Jag & Sara',
  spaceNamePlaceholderDefault: 't.ex. Vår berättelse',
  subjectNamePlaceholder: 't.ex. Emma, Alex, Sam…',
  ...
  copied: 'Kopierat!',
  copyFailed: 'Kunde inte kopiera automatiskt. Tryck länge på länken ovan för att kopiera.',
  close: 'Stäng',
